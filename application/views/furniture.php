...
<?php include 'includes/navbar.php'; ?>
    ...
    <div class="furniture_title">MOBİLYA</div>
    ...
    <div class="furniture_slider">
        <div class="slider" id="slider">
            <div class="slide" id="slide">
              ...
              ?>
              <a href="<?php echo base_url("furniture/$categorys->link");?>"><img class="item" src="<?php echo $categorys->img;?>"></a>
              <?php
              }
              ?>
              <a href="furnutire/saksı.html"><img class="item" src="../img/saksı.png"></a>
              <a href="furnutire/saksı.html"><img class="item" src="../img/saksı.png"></a>
              <a href="furnutire/saksı.html"><img class="item" src="../img/saksı.png"></a>
              <a href="furnutire/saksı.html"><img class="item" src="../img/saksı.png"></a>
              <a href="furnutire/saksı.html"><img class="item" src="../img/saksı.png"></a>
    ...
    <div class="furniture_list">
      ...
      <div class="furniture_card">
        ...
        <button type="submit" class="card_add" onclick="">Sepete Ekle</button>
        </form>
      </div>
      <?php
      }
